...
namespace Assets.Scripts.Stages.FifthStage
{
    public class FifthStageExam : MonoBehaviour
    {
        ...
        private void SettingPointAbonent()
        {
            ...
            {
                AddFourthStageExam("Настройка точки учета абонента", "Неправильно", "Выбрать счетчик в программе, указать его серийный номер, дату выпуска, установки, последней и следующей поверки, часовой пояс и связной номер. Настроить маршрут. Привязать счетчик к точке учета", _sumPoints.SumPoint2(), 0);
            }
        ...
        private void CreateAbonent()
        {
            ...
            {
                AddFourthStageExam("Создание абонента в базе", "Неправильно", "Ввести данные абонента, выбрать тип абонента, указать счетчик", _sumPoints.SumPoint4(), 0);
            }
        ...
        private void DataForSingIn()
        {
            ...
            {
                AddFourthStageExam("Задание данных для входа физлица в личный кабинет «Пирамиды»", "Неправильно", "Выбрать абонента, указать тип профиля и аутентификации, задать пароль для пользователя", _sumPoints.SumPoint5(), 0);
            }
        ...
        private void GetInfoCounter()
        {
            ...
            {
                AddFourthStageExam("Получение показаний со счетчика", "Неправильно", "Выбрать счетчик, задать интервал, выбрать параметр измерения", _sumPoints.SumPoint6(), 0); ;
            }
