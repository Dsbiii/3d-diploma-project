...
public class CableComponent : MonoBehaviour
{
	...
	public bool IsConnectingCable { get; private set; }
	...
	public void ConnectCable(Transform point, Color color)
	{
		ConnectCable(point);
	...
	public void ConnectCable(Transform point)
	{
